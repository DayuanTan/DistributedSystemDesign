...
/**
 * ServiceMulCallbackHandler.java
 *
 ...
 */
    ...
    /**
     *  ServiceMulCallbackHandler Callback class, Users can extend this class and implement
     *  their own receiveResult and receiveError methods.
     */
    public abstract class ServiceMulCallbackHandler{
    ...
    */
    public ServiceMulCallbackHandler(Object clientData){
    ...
    */
    public ServiceMulCallbackHandler(){
     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultgetProduct(
                    com.javahelps.servicemultiply.ServiceMulStub.GetProductResponse result
                        ) {
           }
